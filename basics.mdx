---
title: "Membership"
description: "Types of ownership within PFEC"
---


PFEC is a multi-class hybrid cooperative that has 2 distinct classes of
...
consultation on each project that engages with PFEC.
...
-   Show up as an active owner in PFEC. You are the lifeblood of the
    > community. You rely on others and others rely on your to bring
    > these shows into reality.

-   You participate in community events and activities. Visit the
    > calendar here.

-   You actively participate in proposal governance to influence
    > decision making at PFEC. View open proposals here.

-   You instigate and engage in community discourse and conversation
    > here.
...
activities that will make PFEC successful over the long term: marketing,
...
-   You actively "work" on initiatives as outlined by the Stewards (or
    > by an elected committee) for a minimum of 3 hours per week.

How to become a Contributor Member:

-   Check out PFEC job board here
...
your PFEC account. If you have mistakenly hit this button, please email
[[help@nation.io]{.underline}](mailto:help@nation.io).

Other grounds for termination:

-   The death of an owner.

-   A notice of termination via email in which we will manually
    > terminate your ownership/membership.
...
-   The Stewards expel an owner for cause due to a violation of terms or
    > conduct (or other just cause) using a standard process.